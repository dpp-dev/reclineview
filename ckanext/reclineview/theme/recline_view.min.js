this.ckan.module('recline_view',function(jQuery,_){return{options:{i18n:{errorLoadingPreview:"Nav iespējs ielādēt skatu",errorDataProxy:"DataProxy atgrieza kļūdu",errorDataStore:"DataStore atgrieza kļūdu",previewNotAvailableForDataType:"Skats nav pieejams datu tipam: "},site_url:"",controlsClassName:"controls"},initialize:function(){jQuery.proxyAll(this,/_on/);this.options.resource=JSON.parse(this.options.resource);this.options.resourceView=JSON.parse(this.options.resourceView);this.el.ready(this._onReady);L.Icon.Default.imagePath=this.options.site_url+'vendor/leaflet/0.7.3/images';},_onReady:function(){var resourceData=this.options.resource,resourceView=this.options.resourceView;this.loadView(resourceData,resourceView);},loadView:function(resourceData,reclineView){var self=this;function showError(msg){msg=msg||_('kļūda ielādējot skatu');window.parent.ckan.pubsub.publish('data-viewer-error',msg);}
