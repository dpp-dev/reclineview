this.ckan.module('recline_view', function (jQuery, _) {
  return {
    options: {
      i18n: {
        errorLoadingPreview: "Nav iespējs ielādēt skatu",
        errorDataProxy: "DataProxy atgrieza kļūdu",
        errorDataStore: "DataStore atgrieza kļūdu",
        previewNotAvailableForDataType: "Skats nav pieejams datu tipam: "
      },
      site_url: "",
